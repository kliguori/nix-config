...
9. <s>Move off unstable, except for what requires it</s>
10. etc
11. Reverse proxy
12. <s>Jellyfin</s>
13. Paperless
14. Vaultwarden
15. SOPS-Nix
16. Make sure disko can add BTRFS subvols without being destructive
17. Add tls to domain name
18. Expose some services?
19. Remote access to network tailscale (headscale), netbird, wireguard, cloudflare tunnels, Unifi vpn?
20. Set up outgoing vpn.
21. Etc.
